...
Week one was busy I completed all the setup for this project by creating a Git Repo and cloned the repo to my local storage. I planned what I wanted my project to be and created the core classes for the main systems in my project. I created a working menu and got the player class working with a sanity stat. I got the rooms class working building the individual rooms with names and descriptions and items and the start of an item class. I got the asylum class working intigrating the player and the rooms into a map that the player can move through. I created issues and checked them off as they were completed and pushed updates to git at important milestones. I think for the first week progress was great.
